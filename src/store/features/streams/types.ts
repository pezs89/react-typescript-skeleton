...
export enum StreamActionTypes {
  ...
  FETCH_STREAM_SUCCESS = '@@stream/FETCH_STREAM_REQUEST',
  FETCH_STREAM_FAILURE = '@@stream/FETCH_STREAM_REQUEST',
  EDIT_STREAM_REQUEST = '@@stream/EDIT_STREAM_REQUEST',
  EDIT_STREAM_SUCCESS = '@@stream/EDIT_STREAM_REQUEST',
  EDIT_STREAM_FAILURE = '@@stream/EDIT_STREAM_REQUEST',
  DELETE_STREAM_REQUEST = '@@stream/DELETE_STREAM_REQUEST',
  DELETE_STREAM_SUCCESS = '@@stream/DELETE_STREAM_REQUEST',
  DELETE_STREAM_FAILURE = '@@stream/DELETE_STREAM_REQUEST'
}
